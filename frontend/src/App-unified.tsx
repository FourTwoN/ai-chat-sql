      ...
      <header className="bg-white shadow-lg border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            {isConfigured && (
              <>
                <div className="hidden sm:flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-gray-100 to-gray-50 rounded-lg border border-gray-200">
                  <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  <span className="text-xs font-medium text-gray-700">
                    {model.split('/').pop()}
                  </span>
                </div>
                <div className="hidden sm:flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200">
            ...
            <button
              ...
              className="p-2.5 text-gray-600 hover:bg-gradient-to-r hover:from-gray-100 hover:to-gray-50 rounded-lg transition-all border border-transparent hover:border-gray-200"
              title="Settings"
            >
        ...
        {isConfigured ? (
          <div className="h-full max-w-7xl mx-auto">
            {databaseSettings.type === 'postgresql' && backendStatus === 'offline' && (
              <div className="m-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 text-yellow-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm mt-1">
                      The backend server is not responding. Make sure it's running on <code className="px-1 bg-yellow-100 rounded">{databaseSettings.backendUrl || 'http://localhost:3001'}</code>
                    </p>
                    <p className="text-sm mt-2">
                      Run: <code className="px-2 py-1 bg-yellow-100 rounded font-mono">cd backend && npm run dev</code>
                    </p>
                  </div>
                </div>
              </div>
